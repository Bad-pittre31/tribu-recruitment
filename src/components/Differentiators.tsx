    ...
    <section ref={sectionRef} id="model" className="relative py-40 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="mb-24 text-center">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-bold tracking-tight mb-8 py-3 leading-normal bg-gradient-to-r from-[#19200B] via-[#4a7c59] to-[#19200B] bg-clip-text text-transparent">
